...
| Wizard section reorder/toggle + generate per-section | ✓ Implemented (1.4.0 + 1.5.0) | Per-section generate (1.4.0) + reorder/toggle steps dengan exclude-input AI, wizard-config localStorage; UI WizardStepper ops mode configure |
...
|---------|------|---------|
| 1.5.0 | 2026-09-13 | Wizard reorder/toggle: step reorder + hide (exclude dari input AI), wizard-config persisted localStorage, cloud + self-host |
